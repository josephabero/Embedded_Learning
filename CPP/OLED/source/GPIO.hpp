...
class GPIO
{
 public:
        ...
        void SetLow();
        /// @param state - State::kHigh => set pin high,
        ///                State::kLow => set pin low
 ...
 private:
        ...
        //
        // Upon AttachInterruptHandler(), you will store the user's function
        // callback in this matrix.
        //
        // Upon the GPIO interrupt, you will use this matrix to find and invoke
        // the appropriate callback.
        //
        // Initialize everything to nullptr.
        static sjsu::InterruptHandler pin_isr_map[kPorts][kPins];
        // This function is invoked by NVIC via the GPIO peripheral
        // asynchronously.
        //
        // This ISR should do the following:
        //  1) Find the Port and Pin that caused the interrupt via the
        //     IO0IntStatF,, IO0IntStatR, IO2IntStatF, and IO2IntStatR
        //     registers.
        //  2) Lookup and invoke the user's registered callback.
        //
        // VERY IMPORTANT!
        //  - Be sure to clear the interrupt flag that caused this interrupt,
        //    or this function will be called repetitively and lock your system.
        //  - NOTE that your code needs to be able to handle two GPIO
