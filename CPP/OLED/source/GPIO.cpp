...
void GPIO::GpioInterruptHandler()
{
    ...
    // Check bit 0 for Port 0 Interrupt Status
    if (sjsu::lpc40xx::LPC_GPIOINT->IntStatus & 1)
    {
    ...
    // Check bit 2 for Port 2 Interrupt Status
    else if ((sjsu::lpc40xx::LPC_GPIOINT->IntStatus >> 2) & 1)
    {
